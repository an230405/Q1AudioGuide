...
public static class AppTranslator
{
    private static readonly Dictionary<string, Dictionary<string, string>> _dictionary = new()
    {
        { "vi", new() {
            ...
            { "Home", "Trang chủ" }, { "Qr", "Quét QR" }, { "List", "Danh sách" }, { "Dist", "📍 Cách bạn: {0} km" }, { "Near", "📍 Địa điểm gần đây:" },
        ...
        { "en", new() {
            ...
            { "Home", "Home" }, { "Qr", "Scan QR" }, { "List", "List" }, { "Dist", "📍 Distance: {0} km" }, { "Near", "📍 Nearby location:" },
        ...
        { "zh", new() {
            ...
            { "Home", "首页" }, { "Qr", "扫码" }, { "List", "列表" }, { "Dist", "📍 距离：{0} km" }, { "Near", "📍 附近地点：" },
        ...
        { "ja", new() {
            ...
            { "Home", "ホーム" }, { "Qr", "QR読取" }, { "List", "リスト" }, { "Dist", "📍 距離：{0} km" }, { "Near", "📍 近くの場所:" },
        ...
        { "th", new() {
            ...
            { "Home", "หน้าแรก" }, { "Qr", "สแกน QR" }, { "List", "รายการ" }, { "Dist", "📍 ระยะทาง: {0} km" }, { "Near", "📍 สถานที่ใกล้เคียง:" },
        ...
        { "ko", new() {
            ...
            { "Home", "홈" }, { "Qr", "QR 스캔" }, { "List", "목록" }, { "Dist", "📍 거리: {0} km" }, { "Near", "📍 근처 장소:" },
